...
<html>
    ...
    <head>
        ...
        <title>Requisition (Specific Time)</title>
                ...
                <div class="cardBody p-top-0">
                    <form name = "req_form" id = "req_form" action="" method="post">
                        <div class = "card">
                            <table>
                                <tr class="col-md-2">
                                    <td>Requisition Type: <select name = "req_type">
                                            <option value = "1" selected>Regular</option>
                                            <option value = "2" >Special</option>
                                        </select></td>
                                </tr>
                                <tr>
                                    <td class="col-md-2">Date of Trip: <input name = "req_date" type = "date" onchange="this.form.submit()">
                                </td>
                                </tr>
                                <tr>
                                    <td>
